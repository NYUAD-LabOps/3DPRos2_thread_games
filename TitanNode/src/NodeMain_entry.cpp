...
extern void NodeMain_func(ULONG thread_input);
extern void ProcessManager_entry(void);

extern void ProcessManager_func(ULONG thread_input);
extern void DriveHandler01_func(ULONG thread_input);
extern void USB_CDC_Read_func(ULONG thread_input);
extern void DriveHandler02_func(ULONG thread_input);
extern void DriveHandler03_func(ULONG thread_input);
extern void DriveHandler04_func(ULONG thread_input);
extern void DriveHandler05_func(ULONG thread_input);
extern void DriveHandler06_func(ULONG thread_input);
...
//    ProcessManager_entry();
    ...
    for(i=0;i<ptr_ProcessManager->drive_count;i++){
        if(ptr_ProcessManager->ptr_drive_handlers[i]==NULL){
            tmp_drive_ptr = new SingleMotorLinearDrive();
        }else{
            tmp_drive_ptr = ptr_ProcessManager->ptr_drive_handlers[i];
        }
    }
